...
public class Const {
    ...
    public enum ProductStatus{
        ...
        public static ProductStatus codeOf(Integer code){
            for(ProductStatus productStatus:values()){
                if(code==productStatus.getCode()){
    ...
    public enum SearchEnum{
        ...
        BYCATEGORY(1,"category"),
        BYPRODUCT(2,"product");


        private int code;
        private String desc;
        private SearchEnum(int code,String desc){
            this.code=code;
            this.desc=desc;
        }
        ...
        public static SearchEnum codeOf(Integer code){
            for(SearchEnum searchEnum:values()){
                if(code==searchEnum.getCode()){
                    return searchEnum;
                }
